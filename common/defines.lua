...
NCountry = {
	...
	LAND_FORCELIMIT_EXTRA_COST_FACTOR = 6,			-- extra expense for being above forcelimit
	NAVAL_FORCELIMIT_EXTRA_COST_FACTOR = 6,			-- extra expense for being above forcelimit
