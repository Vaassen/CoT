...
NCountry = {
	...
	MONTHS_TO_CORE_MINIMUM = 12,						-- Minimum amount of months it will take to core a province after all modifiers.
	MONTHS_TO_CORE = 48,							-- How many months it will take to core a province.
	...
	STARTING_ARMY_SIZE = 0.60,						-- Percentage of force limit
	...
	STARTING_FLEET_SIZE = 0.60, 						-- Starting fleet (as percentage of forcelimits)
	...
	SEND_OFFICERS_MAINTENANCE_MULTIPLIER = 0.50,
	...
	LOW_ARMY_PROFESSIONALISM_MAX_RANGE = 0.2,
...
NEconomy = {
	...
	MIN_ARMY_MAINTENANCE = 0.20,
	MIN_NAVY_MAINTENANCE = 0.2,
...
NMilitary = {
	...
	LEADER_MAX_PIPS = 7,								-- Max general/admiral pips (per skill)
